...
public class EditInformationForm {
    ...
    public EditInformationForm(final HttpServletRequest request) {
        firstName = FormHelper.sanitize(request.getParameter("firstName"));
        lastName = FormHelper.sanitize(request.getParameter("lastName"));
        button = FormHelper.sanitize(request.getParameter("editInformationButton"));
    ...
    public List<String> getValidationErrors() {
        ...
        assert button != null;
        if (!button.equals("Edit Information")) {
    ...
    protected enum ErrorMessage {
        ...
        public String toString() {
            switch (this) {
                ...
                case BUTTON_IS_NULL:
                    return "Action is required, no EditInformation button is hit";
