            ...
            <ul class="nav navbar-nav mr-auto" id="myTab1" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab"
                       href="#home" role="tab" aria-controls="home" aria-selected="true"><span
                            class="fa fa-home"></span> Index</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="about-tab" data-toggle="tab"
                       href="#about" role="tab" aria-controls="about" aria-selected="false"><span
                            class="fa fa-leaf"></span> About</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="contact-tab" data-toggle="tab"
                       href="#contact" role="tab" aria-controls="contact" aria-selected="false"><span
                    ...
                    <div class="m-3 pt-2 px-5 bg-light">
                        ...
                        <div>
                            <form method="GET" id="registerForm" action="register.do">
                                <div class="form-group">
                                    <label for="registerButton">Want to create a new account? Register
                                        Here:&nbsp;</label>
                        ...
                        <div class="my-2">
                            ...
                            <div class="pb-2">
                                <form method="GET" id="adminLoginForm" action="adminLogin.do">
                                    <div class="form-group">
                                        <label for="adminLoginButton">Please login to Administration Page from
                                            Here:</label>
